            ...
            <div class="container mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <p>Alors Champion, connecte toi !</p>
...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if(empty($email) && empty($password)){
            ...
            $query_admin = "SELECT * FROM `users` WHERE email='$email' and motpasse='".md5($password)."'";
            $result_admin = mysqli_query($conn, $query_admin) or die(mysql_error());
