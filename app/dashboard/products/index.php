<?php 
  ...
  $resultnbr = $conn->query("SELECT COUNT(*) AS nb FROM products");
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Produits<br><span><?php echo $nbr_item['nb']; ?> créations</span></h5>
              
                <div>

                  <a href="add/">Creer une nouvelle fiche de produit</a>
