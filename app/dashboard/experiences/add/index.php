...
<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    //Cover
      $output_dir = "../../../../assets/img/experiences/cover/";/* Path for file upload */
    ...
    if(empty($nom) && empty($about) && empty($lienprojet)){
      ...
      $sql = $conn -> query("INSERT INTO `experiences` (`nom`, `intro`, `about`, `cover`,`lien`) VALUES('$nom','$intro','$about','$cover','$lienprojet')");
