<?php 
    ...
    $resultstudio = $conn->query("SELECT COUNT(*) AS nb FROM products");
...
<head>
    ...
    <title>produits • datkominformatics | Entreprise Informatique</title>
</head>
<body>
            ...
            <div class="container header-cta">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <h1 id="products-header-title">Creativité, Design & Code.<br>Profondément liés.</h1>
                    ...
                    <?php foreach ($creations as $creation): ?>
                        ...
                        <div id="dreamstudio-case">
                            ...
                            <a href="creation/?nom=<?= $creation['nom']; ?>">
                                ...
                                <img src="../assets/img/products/cover/<?php echo $creation['cover'] ?>" alt="<?php echo $creation['nom'] ?>" width="50%">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="py-5 text-center">
                                ...
                                <br><br>
                                <p id="wait">Nous concevons nos produits en intégrant des capacités et des expériences utilisateur uniques pour former un véritable écosystème.</p>
