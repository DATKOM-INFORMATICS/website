...
<body id="crea_body">
    ...
    <div class="container-fuid" id="creation-head" style="background-image: url('../../assets/img/experiences/cover/<?php echo $creation[4]; ?>'), linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5))">
    ...
    <div class="container mb-5">
        ...
        <div class="row mt-4 justify-content-center">
            ...
            <div class="col-md-5">
                ...
                <img src="../../assets/img/experiences/cover/<?php echo $creation[4]; ?>" alt="<?php echo $creation[1]; ?>" class="crea_cover_img">
